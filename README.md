...
* [Javascript & JSX Syntax](#js-syntax)
...
- [react/jsx-equals-spacing](https://github.com/yannickcr/eslint-plugin-react/blob/master/lib/rules/jsx-equals-spacing.js)
- [react/jsx-no-duplicate-props](https://github.com/yannickcr/eslint-plugin-react/blob/master/lib/rules/jsx-no-duplicate-props.js)
- [react/jsx-no-undef](https://github.com/yannickcr/eslint-plugin-react/blob/master/lib/rules/jsx-no-undef.js)
- [react/jsx-pascal-case](https://github.com/yannickcr/eslint-plugin-react/blob/master/lib/rules/jsx-pascal-case.js)
- [react/jsx-uses-react](https://github.com/yannickcr/eslint-plugin-react/blob/master/lib/rules/jsx-uses-react.js)
- [react/jsx-uses-vars](https://github.com/yannickcr/eslint-plugin-react/blob/master/lib/rules/jsx-uses-vars.js)
- [react/no-deprecated](https://github.com/yannickcr/eslint-plugin-react/blob/master/lib/rules/no-deprecated.js)
- [react/no-direct-mutation-state](https://github.com/yannickcr/eslint-plugin-react/blob/master/lib/rules/no-direct-mutation-state.js)
- [react/no-is-mounted](https://github.com/yannickcr/eslint-plugin-react/blob/master/lib/rules/no-is-mounted.js)
- [react/no-multi-comp](https://github.com/yannickcr/eslint-plugin-react/blob/master/lib/rules/no-multi-comp.js)
- [react/react-in-jsx-scope](https://github.com/yannickcr/eslint-plugin-react/blob/master/lib/rules/react-in-jsx-scope.js)
- [react/require-render-return](https://github.com/yannickcr/eslint-plugin-react/blob/master/lib/rules/require-render-return.js)
